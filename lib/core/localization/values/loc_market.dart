...
class MarketLoc {
  String get convert => tr("data.market.convert");
  String get spot => tr("data.market.spot");
  String get margin => tr("data.market.margin");
  String get fiat => tr("data.market.fiat");
  String get addFavorite => tr("data.market.add_favorite");
